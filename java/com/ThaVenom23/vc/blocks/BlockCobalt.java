...
public class BlockCobalt extends Block {
	...
	public static int id = 4003;

	public BlockCobalt(Material material, int id) {
		super(material);
		...
		this.setBlockTextureName(References.MODID + ":" + "cobalt_block");
		this.setBlockName("Cobalt Block");
	}

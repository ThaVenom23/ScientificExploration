...
public class BlockMarbleBrick extends Block {
	...
	public static int id = 3002;

	public BlockMarbleBrick(Material material, int id) {
		super(material);
		this.setStepSound(soundTypeStone);
		this.setHardness(4f);
		this.setResistance(1.0f);
		this.setCreativeTab(VenomCraft.tabVC);
		this.setBlockTextureName(References.MODID + ":" + "marble_brick");
		this.setBlockName("Marble Brick");
	}

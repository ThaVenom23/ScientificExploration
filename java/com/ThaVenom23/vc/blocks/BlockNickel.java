...
public class BlockNickel extends Block {
	...
	public static int id = 4008;

	public BlockNickel(Material material, int id) {
		super(material);
		...
		this.setBlockTextureName(References.MODID + ":" + "nickel_block");
		this.setBlockName("Nickel Block");

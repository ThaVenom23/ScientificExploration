...
public class OreChromium extends Block {
	...
	public static int id = 3012;

	public OreChromium(Material material, int id) {
		super(material);
		...
		this.setBlockTextureName(References.MODID + ":" + "chromium_ore");
		this.setBlockName("Chromium Ore");

...
public class BlockHematite extends Block {
	...
	public static int id = 4006;

	public BlockHematite(Material material, int id) {
		super(material);
		...
		this.setBlockTextureName(References.MODID + ":" + "hematite_block");
		this.setBlockName("Hematite Block");
